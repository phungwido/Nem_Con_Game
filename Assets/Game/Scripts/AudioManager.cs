...
public class AudioManager : MonoBehaviour
{
    ...
    public static void OnPlayClick() { PlaySound(instance.soundClick); }
    public AudioClip soundClick;

    public static void OnPlayWin() { PlaySound(instance.soundWin); }
    public AudioClip soundWin;

    public static void OnPlayLose() { PlaySound(instance.soundLose); }
